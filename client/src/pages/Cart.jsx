...
//                 <button
//                     onClick={placeOrder}
//                     className="w-full py-3 mt-6 cursor-pointer bg-primary text-white 
...
const Cart = () => {
    ...
    return (products.length > 0 && cartItems) ? (
        <div className="flex flex-col md:flex-row mt-16">
            ...
            {/* ORDER SUMMARY */}
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 mt-10 md:mt-0 border border-gray-300">
